	...
	contentDiv.innerHTML = `
		<div class="relative flex flex-col items-center h-full">
			...
			<div class="flex flex-col space-y-4 items-center flex-grow justify-center">
				<label class="text-xl">Number of Players (Max: 8)</label>
				<input type="number" id="player-count" class="p-2 border rounded text-center w-24" min="1" max="8" value="4">
				<button id="start-tournament" class="btn bg-purple-500 text-white text-xl py-3 px-6 rounded-lg shadow-lg hover:bg-purple-600 transition duration-300">
					Start Tournament
				</button>
			</div>
		</div>
